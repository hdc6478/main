namespace game {
     ...
     * 神技飘字(新)
     */
    export class GodSkillEftNameNew extends DisplayObjectContainer {

        private static _ins: GodSkillEftNameNew;

        public static getIns(): GodSkillEftNameNew {
            if (!this._ins) {
        ...
        public show(idx: number) {
            let _skill: GodSkillEftNameItemNew = Pool.alloc(GodSkillEftNameItemNew);
            _skill.show(idx);
        }
    }

    export class GodSkillEftNameItemNew extends DisplayObjectContainer {
        ...
        constructor() {
            ...
            this.img_godName.anchorOffsetX = 171;
            this.img_godName.anchorOffsetY = 70;
        ...
        public show(idx: number): void {
            ...
            this.img_godBg.source = ResUtil.getSkillEffectSrc("jinengdi3");
