namespace game.mod {
     ...
     * 参考 SurfaceUpTipsMdr
     */
    export class BreakthroughTipsMdr extends EffectMdrBase {
        private _view: BreakthroughTipsView = this.mark("_view", BreakthroughTipsView);
        ...
        private updateShow(): void {
            ...
            this._view.lab_desc.textFlow = TextUtil.parseHtml(this._showArgs.attrDesc1);
        }
