namespace game.mod {
     ...
     * 排行榜组件
     */
    export class RankRender extends eui.ItemRenderer {
        ...
        public data: rank_common_struct;//排行榜数据
        ...
        protected dataChanged() {
            ...
            let power = data.showpower ? StringUtil.getHurtNumStr(data.showpower.toNumber()) : 0;
