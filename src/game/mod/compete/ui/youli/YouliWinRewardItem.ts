namespace game.mod.compete {
    ...
    export class YouliWinRewardItem extends BaseRenderer {
        ...
        private onClick(): void {
            ...
            let tips = StringUtil.substitute(getLanById(LanDef.youli_award_tips), [cfg.count]);
        ...
        protected dataChanged(): void {
            ...
            let status = this._proxy.getYouliWinRewardStatus(cfg);
