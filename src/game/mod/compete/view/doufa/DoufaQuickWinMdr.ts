namespace game.mod.compete {
    ...
    export class DoufaQuickWinMdr extends EffectMdrBase {
        private _view: DoufaQuickWinView = this.mark("_view", DoufaQuickWinView);
        ...
        protected onHide(): void {
            facade.sendNt(CompeteEvent.DOUFA_RESET_CHALLENGE);
            super.onHide();
        }
