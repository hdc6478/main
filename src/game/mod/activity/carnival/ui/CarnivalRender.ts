namespace game.mod.activity {
    ...
    export class CarnivalRender extends BaseListenerRenderer {
        ...
        protected dataChanged(): void {
            ...
            let score = this._carnivalProxy.getScore(actInfo.act_id);
            let descStr = StringUtil.substitute(getLanById(LanDef.carnival_tips3), [limitScore])
            ...
            let hasDraw = this._carnivalProxy.hasCarnivalDraw(actInfo.act_id, data);
            this.btn_draw.visible = !hasDraw;
            this.img_draw.visible = hasDraw;
            if(this.btn_draw.visible){
                let canDraw = this._carnivalProxy.canCarnivalDraw(actInfo.act_id, data);
        ...
        private onClickDraw(): void {
            ...
            //前往召唤
            ViewMgr.getIns().showViewByID(JumpIdx.Summon, undefined, false);
        }
