namespace game.mod.union {
    ...
    export class UnionTreasureRankMdr extends EffectMdrBase implements UpdateItem {
        ...
        protected addListeners(): void {
            ...
            this.onNt(UnionEvent.ON_UPDATE_TREASURE_RANK_INFO, this.onUpdateView, this);
        }
        ...
        private onUpdateTips(): void {
            ...
            if (this._type == UnionRankType.Guild) {
                let list = this._proxy.getRankProps(UnionRank.Treasure);
                if (list && list.length) {
                    this._tips = true;
                    ViewMgr.getIns().showUnionRankTips(UnionRank.Treasure);
                }
            }
        }
