namespace game.mod.union {
    ...
    export class UnionBookUpTipsMdr2 extends EffectMdrBase {
        private _view: UnionBookUpTipsView2 = this.mark("_view", UnionBookUpTipsView2);
        ...
        private updateShow(): void {
            ...
            let skillId2 = this._showArgs.skillId2;
            ...
            this._view.lab_desc2.textFlow = TextUtil.parseHtml(cfg.des);

            let cfgBefore: BuffConfig = getConfigByNameId(ConfigName.Buff, skillId2);
            this._view.lab_desc1.textFlow = TextUtil.parseHtml(cfgBefore.des);
