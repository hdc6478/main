namespace game.mod.pay {
    ...
    export class GiftMdr extends EffectMdrBase {

        private _view: GiftView = this.mark("_view", GiftView);
        ...
        private updateShow(): void {
            ...
            this._view.img_text.source = ResUtil.getUiPng(`libaozhufu_${this._productId}`);
            if(!rewards){
                return;
            }
