namespace game.mod.yijie {
    ...
    export class YijieLuckyMdr extends MdrBase implements UpdateItem {
        private _view: YijieLuckyView = this.mark("_view", YijieLuckyView);
        ...
        public _showArgs: s2c_yijie_boss_roll_point;
        ...
        protected onInit(): void {
            ...
            this._view.list_item.itemRenderer = YijieLuckyItem;
        ...
        private updateReward(): void {
            ...
            let cfg = this._proxy.getBossCfg(stage, index) as YijieConfig;
