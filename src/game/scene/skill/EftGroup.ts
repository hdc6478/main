namespace game.scene {
    ...
    export class EftGroup extends BaseDraw {
        ...
        public setData(eftId: string | number, src: string, actor: BaseActor, cb: Handler) {
            let self = this;
        ...
        public advanceTime(elapseTime: number): void {
            ...
            for (let i = 0; i < this._len; ++i) {
                ...
                if (this._elapseTime - this._startTime >= eftCfg.delay && !isAdded) {
                    ...
                    SkillEftMgr.ins.showSkillEft(eftCfg.id, x, y, rotation, eftCfg, r, dir, this.scaleY,this.layer);
