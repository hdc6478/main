...
declare namespace base {
    class GameService extends ObjBase {
        connectTo(host: string, port: number): void;
        isConnected(): boolean;
        close(): void;
...
declare namespace base {
    ...
    class Facade {
        ...
        deleteMdr(moduleName: string, viewType: string): void;
        sendNt(notify: string, data?: any): void;
        onNt(notify: string, method: (ntfy: GameNT) => void, context: any): void;
        offNt(notify: string, method: (ntfy: GameNT) => void, context: any): void;
        onConnectLost(): void;
    }
    const facade: Facade;
}
